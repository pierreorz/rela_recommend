...
var MatchAlgoV1_3 QuickMatchTreeV1_3
...
func init() {
	...
	// v1.3
	modelFileV1_3 := Work_dir + "/algo_files/quick_match_tree_v1.3.model"
	MatchAlgoV1_3 = QuickMatchTreeV1_3{QuickMatchBase{FilePath: modelFileV1_3}}
	MatchAlgoV1_3.Init()
