...
var richStrategyMap = map[string]algo.IRichStrategy{
	...
	"live_group_rec":          &strategy.BaseRichStrategy{StrategyFunc: liveGroupRecommendStrategy},
	"live_top_rec":          &strategy.BaseRichStrategy{StrategyFunc: liveGroupTopRecommendStrategy},
...
var algosMap = algo.AlgoListInitToMap([]algo.IAlgo{
	...
	&algo.AlgoBase{AlgoName: "model_around_new_1.1.1", FilePath: workDir + "around_1.1.1.gz",
		Model: &utils.XgboostClassifier{}, FeaturesFunc: GetMomentFeatures},
	&algo.AlgoBase{AlgoName: "model_around_new_1.1.2", FilePath: workDir + "mods_near_1.1.dumps.gz",
		Model: &utils.GradientBoostingLRClassifier{}, FeaturesFunc: GetMomentFeatures},
	...
	&algo.AlgoBase{AlgoName: "model_around_new_1.2.3", FilePath: workDir + "mods_near_1.3.dumps.gz",
		Model: &utils.GradientBoostingLRClassifier{}, FeaturesFunc: GetMomentFeatures},
	&algo.AlgoBase{AlgoName: "model_around_new_1.2.4", FilePath: workDir + "mods_near_1.4.dumps.gz",
		Model: &utils.GradientBoostingLRClassifier{}, FeaturesFunc: GetMomentFeatures},
})
