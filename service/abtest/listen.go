...
func init() {
	...
	white_config := `{
		...
		"moment": [
			{"name": "moment_hot", "desc": "热门日志", "app": "moment", "ids":[104708381],"factor_map":{"new_moment_len":"300", "new_moment_offset_second": "86400", "recommend_list_key": "moment_recommend_list:%d","strategy:time_level:weight": "-1"}}
		]
	}`
